...
<head>
    <title>Yudhistira Armico Fidly : 5026231067</title>
    <meta charset="utf-8">
...
<body>
    <div class="jumbotron text-center mx-auto">
        <h1>5026231067 : Yudhistira Armico Fidly</h1>
    </div>

    <nav class="navbar navbar-expand-sm bg-light">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="/land">All Front End</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/pegawai">Pegawai</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/tas">Tugas CRUD</a>
            </li>
            <li class="nav-item">
